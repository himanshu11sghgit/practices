                    ...
                    for (let i=0; i<students.length; i++)
                    {
                        content += `
                            <tr>
                                ...
                                <td id="col-action">
                                    <button class="btn btn-sm btn-warning btn-update" data-sid=${students[i].id}>Update</button>
                                    <button class="btn btn-sm btn-danger btn-delete" data-sid=${students[i].id}>Delete</button>
                                </td>
                            </tr>
                        `
                    }
    ...
    $.ajax({
        ...
        success: function(data) 
        {
            if (data.status === 200)
            {
                ...
                thisElement.closest("tr").fadeOut("slow", function()
                {
